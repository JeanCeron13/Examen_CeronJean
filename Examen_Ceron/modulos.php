...
<body>
	...
	while ($columna = mysqli_fetch_array( $resultado ))
	{
        ...
        echo "<tr>";
        echo "<td>" . $columna['COD_MODULO'] ."</td>
        <td>" . $columna['NOMBRE'] ."</td>
        <td>".$columna['ESTADO']."</td>
        <td>
            <button type='button' class='btn btn-warning'><a href='editarModulo.php?COD_MODULO=".$columna["COD_MODULO"]."'>Editar</a></button>
            <button type='button' class='btn btn-danger'><a href='eliminarModulo.php?COD_MODULO=".$columna["COD_MODULO"]."'>Eliminar</a></button>
